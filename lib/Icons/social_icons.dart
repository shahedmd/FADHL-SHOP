...
class SocialIcons {
  ...
  static Widget instagram({
    double size = 24,
    Color color = const Color(0xFFE4405F),
  }) {
    return _svg(
      size,
      color,
  ...
  // ✅ Fixed builder — uses SvgPicture.string() which works on Flutter Web
  static Widget _svg(double size, Color color, String path) {
    final svgString = '''
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <path fill="${_toHex(color)}" d="$path"/>
</svg>''';
